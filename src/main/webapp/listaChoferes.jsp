              ...
              >
                ...
                >
                  <tr class="text-center">
                    ...
                    <th scope="col" class="px-6 py-3">AP MATERNO</th>
                    <th
                      scope="col"
                      class="px-6 py-3 bg-gray-50 dark:bg-gray-800"
                    >
                    ...
                    <th scope="col" class="px-6 py-3">EDITAR CHOFER</th>
                    <th
                      scope="col"
                      class="px-6 py-3 bg-gray-50 dark:bg-gray-800"
                    >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="py-6"><%=c.getNombre()%></td>
                    <td class="py-6"><%=c.getApPaterno()%></td>
                    <td class="py-6"><%=c.getApMaterno()%></td>
                    <td class="py-6"><%=c.getLicencia()%></td>
                    <td class="py-6"><%=c.getTelefono()%></td>
                    <td class="py-6">
                      <a
