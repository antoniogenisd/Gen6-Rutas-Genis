      ...
      <body>
        ...
        <section class="px-6">
          <div class="flex text-center p-20 justify-center">
            <h2 class="text-2xl font-bold text-ceter">Formulario Alta De Choferes</h2>
          </div>
            ...
            <% if(errores != null && errores.size()>0){ %>
              ...
              <div>
                <form
                action="<%=request.getContextPath()%>/choferes/alta"
                method="post"
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="mb-5">
                        ...
                        <input type="text" name="nombre" id="nombre" value="${param.nombre}" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="apPaterno" id="apPaterno" value="${param.apPaterno}" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  ...
                  <div class="grid grid-cols-2 gap-6">
                    <div class="mb-5">
                        ...
                        <input type="text" name="licencia" id="licencia" value="${param.licencia}" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="telefono" id="telefono" value="${param.telefono}" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="date" name="fechaNacimiento" id="fechaNacimiento" value="${param.fechaNacimiento}" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
